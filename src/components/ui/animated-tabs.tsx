// src/app/components/ui/animated-tabs.tsx
'use client';

import { useState } from "react";
import { motion, AnimatePresence } from "framer-motion"; // Import corrigé
      ...
      >
        {propTabs.map((tab, idx) => (
          ...
          >
            ...
            <span className="relative block text-secondary-foreground">
              {tab.title}
            </span>
          </button>
        ))}
